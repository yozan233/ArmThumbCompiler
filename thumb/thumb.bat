@REM THUMB.BAT - A simple batch script to assemble ARM/THUMB assembly files into binary format.
@REM Requires GNU Binutils (as.exe and objcopy.exe) to be installed and accessible via the system PATH.
@echo off
@if "%~1" == "" goto Syntax
@set src=%~1
